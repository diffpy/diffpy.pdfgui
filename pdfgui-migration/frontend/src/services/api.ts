...
export const fittingsApi = {
  list: (projectId: string) => api.get(`/fittings/project/${projectId}`),

  get: (id: string) => api.get(`/fittings/${id}`),
  ...
  stop: (id: string) => api.post(`/fittings/${id}/stop`),

  getStatus: (id: string) => api.get(`/fittings/${id}/status`),

  getParameters: (id: string) => api.get(`/fittings/${id}/parameters`),

  addConstraint: (
    id: string,
    data: { target: string; formula: string; phase_id?: string },
  ) => api.post(`/fittings/${id}/constraints`, data),
};

// Phases API
export const phasesApi = {
  list: (fittingId: string) => api.get(`/phases/fitting/${fittingId}`),

  get: (id: string) => api.get(`/phases/${id}`),
  ...
  getAtoms: (id: string) => api.get(`/phases/${id}/atoms`),
...
export const datasetsApi = {
  list: (fittingId: string) => api.get(`/datasets/fitting/${fittingId}`),
  ...
  getData: (id: string) => api.get(`/datasets/${id}/data`),
  ...
  updateFitRange: (
    id: string,
    data: { rmin: number; rmax: number; rstep: number },
...
export const filesApi = {
  ...
  getPreview: (id: string) => api.get(`/files/${id}/preview`),
